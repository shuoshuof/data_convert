...
class SkMotionVisualizer(RobotVisualizer):
    ...
    def update_robot(self):
        ...
        for i in range(self.num_subplots):
            ...
            parent_indices[0]=0
            link_global_rotations = self.data[i].local_rotation[self.counter]
...
if __name__ == '__main__':
    import pickle
    with open('motion_data/11_2/hu_motion/walk_medium_step1_motion.pkl','rb') as f:
